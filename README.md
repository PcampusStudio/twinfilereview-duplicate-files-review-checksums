...
<div align="center">
  <img src="./public/logo.svg" alt="TwinFileReview — Local files — Checksums" width="64" height="64">
  <h1>TwinFileReview — Local files — Checksums</h1>
</div>

An independent project specification for Local files, covering size prefilter report, content hash verification, manual review queue.
...
<img src="./public/screenshots/desktop-main.svg" alt="Local files — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Local files — compact concept, not a screenshot" width="250">
<br>
...
- **Size prefilter report** — planned module; not implemented.
- **Content hash verification** — planned module; not implemented.
- **Manual review queue** — planned module; not implemented.

The proposed workflow separates size prefilter report from content hash verification, with manual review queue retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Size prefilter report**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="TwinFileReview — Local files — Checksums — specification review workflow">
<br>
...
### Size prefilter report

Define the input and expected outcome for module 1. Record the Local files version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Content hash verification

Define the input and expected outcome for module 2. Record the Local files version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Manual review queue

Define the input and expected outcome for module 3. Record the Local files version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.
...
| Planned output | Size prefilter report |
